...
exports.buildDashboardChartData = exports.QUERY_DASHBOARD_CHART_7DAYS = exports.QUERY_DASHBOARD_TOP_CLIENTS = exports.QUERY_DASHBOARD_METRICS = void 0;
/**
 * Query: Consolidated dashboard metrics.
 */
const QUERY_DASHBOARD_METRICS = () => {
    return `SELECT 
...
exports.QUERY_DASHBOARD_METRICS = QUERY_DASHBOARD_METRICS;
/**
 * Query: Top clients by available points (limit 5).
 */
const QUERY_DASHBOARD_TOP_CLIENTS = () => {
    return `
    SELECT
...
exports.QUERY_DASHBOARD_TOP_CLIENTS = QUERY_DASHBOARD_TOP_CLIENTS;
/**
 * Query: 7-day chart series (timezone fixed to America/Sao_Paulo).
 */
const QUERY_DASHBOARD_CHART_7DAYS = () => {
    return `
    WITH params AS (
...
exports.QUERY_DASHBOARD_CHART_7DAYS = QUERY_DASHBOARD_CHART_7DAYS;
const buildDashboardChartData = (rows) => {
...
exports.buildDashboardChartData = buildDashboardChartData;
